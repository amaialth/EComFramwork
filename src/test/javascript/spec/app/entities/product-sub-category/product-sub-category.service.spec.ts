...
describe('Service Tests', () => {
  describe('ProductSubCategory Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new ProductSubCategory(0, 0, 0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ProductSubCategory', async () => {
        ...
        service
          .create(new ProductSubCategory(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should delete a ProductSubCategory', async () => {
